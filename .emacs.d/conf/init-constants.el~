...
(defconst *projects-directory*
  (path-join *user-home-directory* "Desktop/ProgrammingLanguages")
...
(defconst *all-project-directories*
  (list
   *projects-directory*
   (path-join *projects-directory* "/Desktop/ProgrammingLanguages") ;; you can duplicate or delete this line if you want
   )
